...
CREATE TABLE tfcqe.posts (
  ...
  `multimedia` text COLLATE utf8mb4_general_ci NULL,
  `respuestas` text COLLATE utf8mb4_general_ci NULL,
...
-- Dump completed on 2023-06-24 17:23:37
